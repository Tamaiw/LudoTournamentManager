...
const docTemplate = `{
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/inbound.UserDTO"
                        }
                    },
                    "401": {
                        "description": "Unauthorized",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.createLeagueRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "delete": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.deleteLeagueResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.generateLeaguePairingsRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.leagueStandingsResponse"
                        }
                    },
                    "400": {
                        "description": "Bad Request",
                ...
                "parameters": [
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.createTournamentRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "put": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.updateTournamentRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "post": {
                ...
                "parameters": [
                    ...
                    },
                    {
                        ...
                        "required": true,
                        "schema": {
                            "$ref": "#/definitions/http.reportMatchRequest"
                        }
                    }
                ],
                "responses": {
            ...
            "get": {
                ...
                "responses": {
                    "200": {
                        "description": "OK",
                        "schema": {
                            "$ref": "#/definitions/http.listUsersResponse"
                        }
                    },
                    "500": {
                        "description": "Internal Server Error",
    ...
    "definitions": {
        "http.createLeagueRequest": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string",
                    "example": "Spring League 2026"
                },
                "organizerId": {
                    "type": "string",
                ...
                "settings": {
                    "$ref": "#/definitions/models.LeagueSettings"
                }
            }
        },
        "http.createTournamentRequest": {
            "type": "object",
            "properties": {
                "name": {
                    "type": "string",
                ...
                "settings": {
                    "$ref": "#/definitions/models.TournamentSettings"
                }
            }
        },
        "http.deleteLeagueResponse": {
        ...
        "http.generateLeaguePairingsRequest": {
            "type": "object",
            "properties": {
                "playDate": {
                    "type": "string",
        ...
        "http.reportMatchRequest": {
            ...
            "properties": {
                ...
                "results": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/inbound.MatchResult"
                    }
                }
            }
        },
        "http.updateTournamentRequest": {
            "type": "object",
            "properties": {
                "settings": {
                    "$ref": "#/definitions/models.TournamentSettings"
        ...
        "inbound.MatchResult": {
            ...
            "properties": {
                ...
                "seatColor": {
                    "$ref": "#/definitions/models.SeatColor"
                }
            }
        },
        "inbound.UserDTO": {
        ...
        "models.AdvancementConfig": {
            "type": "object",
            "properties": {
                "advancement_per_game": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.AdvancementPerGame"
                    }
                },
                "games": {
                    "type": "integer"
        ...
        "models.AdvancementPerGame": {
            ...
            "properties": {
                ...
                "placements": {
                    "description": "e.g., [1, 2] means 1st and 2nd advance",
                    "type": "array",
                    "items": {
                        "type": "integer"
                    }
        ...
        "models.League": {
            ...
            "properties": {
                ...
                "status": {
                    "$ref": "#/definitions/models.LeagueStatus"
                }
            }
        },
        "models.LeagueSettings": {
            ...
            "properties": {
                ...
                "scoring_rules": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.ScoringRule"
                    }
                },
                "tables_count": {
                    "type": "integer"
        ...
        "models.TournamentSettings": {
            ...
            "properties": {
                "advancement": {
                    "type": "array",
                    "items": {
                        "$ref": "#/definitions/models.AdvancementConfig"
                    }
                },
                "default_reporter": {
                    "description": "\"lowest_advancing\"",
                    "type": "string"
                },
                "tables_count": {
                    "type": "integer"
        ...
        "models.TournamentStatus": {
            ...
            "x-enum-varnames": [
                ...
                "TournamentStatusLive",
                "TournamentStatusComplete"
            ]
        }
    }
}`
